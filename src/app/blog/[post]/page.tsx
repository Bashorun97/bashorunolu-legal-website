...
const Effctive = () => {
  return (
    <div>
      ...
      <div className="bg-red-400 my-8 mx-20" style={{height: "45rem"}}></div>
      ...
      <div className="px-80">
        <p>
          The toppings you may chose for that TV dinner pizza slice when you forgot to shop for foods, the paint you may slap on your face to impress the new
        ...
        <p>
          ...
          Design comps,uts, wireframes—will your clients accept that you go about things the facile way? Authorities
